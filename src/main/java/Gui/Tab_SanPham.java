...
//            Object[] rowData = {sp.getMaSP(), sp.getTenSP(), sp.getNhaCungCap().getTenNCC(), sp.getLoaiSP(), sp.getSoLuongTK(), sp.getDonGiaBan()};
//            dtm.addRow(rowData);
//        }
    	clearTableSanPham();
    	DefaultTableModel dtm = (DefaultTableModel) jTableDSSP.getModel();
    		try {
    			...
    			for (SanPham s : listSach) {
    				...
    				{
    					String Sach = "Sách";
				Object[] rowData = { s.getMaSP(),s.getTenSP(),s.getNhaCungCap().getTenNCC(),Sach,s.getSoLuongTK(),s.getDonGiaBan() };
				dtm.addRow(rowData);}
		...
		e.printStackTrace();
    		...
    		try {
    			...
    			for (VPP s : listSach) {
    				...
    				{
    					String vpp = "VPP";
    					Object[] rowData = { s.getMaSP(),s.getTenSP(),s.getNhaCungCap().getTenNCC(),vpp,s.getXuatXu(),s.getMauSac(),s.getChatLieu(),s.getSoLuongTK(),s.getDonGiaBan() };
    					dtm.addRow(rowData);
    				}
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextFieldDinhMuc, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jRadioButtonAll, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jRadioButtonCon)
                            .addComponent(jRadioButtonTren, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTableDSSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩm", "Nhà cung cấp", "Loại sản phẩm", "Số lượng", "Đơn giá bán"
            }
        ));
...
//        }
    ...
    private void jButtonBanChayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBanChayActionPerformed
        // TODO add your handling code here:
//        ArrayList<SanPham> listSanPham = sanPham_DAO.topNSanPhamBanChay();
//        new FormSanPhamBanChay(listSanPham).setVisible(true);
...
//        new FormSanPhamBanCham(listSanPham).setVisible(true);
